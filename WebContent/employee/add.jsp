...
<body>
	<html:form action="/employee" styleId="formAdd">
		<html:hidden property="dispatch" />
		<table>
			<tr>
				<td>Employee name</td>
				<td><html:text property="empname" size="40" /></td>
			</tr>
			<tr>
				<td>Employee Designation</td>
				<td><html:text property="designation" size="40" /></td>
			</tr>
			<tr>
				<td>Employee Salary</td>
				<td><html:text property="salary" size="20" /></td>
			</tr>
			<tr>
